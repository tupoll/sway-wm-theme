...
local function show() os.execute('notify-send "$( notify-send "Время" "$(~/.config/sway/modules/alert/date.sh )")"') end;
...
setInterval(60000,  function() show() end)
...
kilInterval(59500,  function() kil() end)
